...
// ... (Payment ve Packets type'ları aynı kalıyor)
...
export default function PaymentsPage() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {payments.length === 0 ? (
        <p className="text-gray-600">Henüz ödeme yapılmamış.</p>
      ) : (
              ...
              >
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                  <div className="text-sm sm:text-base text-gray-700 space-y-1">
                    ...
                    <button
                      className="underlinetransition flex"
                      onClick={() => toggleExpanded(pay.id)}
                    >
                      <strong>Paket Adı: {pay.paket}</strong>
                      <p className="text-blue-600 hover:no-underline underline">
                        {expandedId === pay.id
                          ? "Detayları Gizle"
                          : "Detayları Göster"}
                      </p>
