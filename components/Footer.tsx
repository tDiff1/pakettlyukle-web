      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="flex space-x-4 mt-3">
            <Image
              src="https://9p0znkmu3n4ej0xg.public.blob.vercel-storage.com/pakettlyukle/other-pic/visa.png"
              width={50}
              height={50}
              alt="Visa"
            />
            <Image
              src="https://9p0znkmu3n4ej0xg.public.blob.vercel-storage.com/pakettlyukle/other-pic/mastercard.png"
              width={50}
              height={50}
              alt="Mastercard"
            />
        ...
        <div>
          <Link href="/yasal" className="hover:underline">
            <h1 className="text-xl md:text-2xl font-bold mb-3">
              {getContent("footer_title_two")}
            </h1>
          </Link>
          <div className="flex flex-col space-y-2">
            <Link
              href="/yasal?section=iptal-ve-iade"
              className="hover:underline"
            >
              İptal ve İade Koşulları
            </Link>
            <Link href="/yasal?section=kvkk" className="hover:underline">
              KVKK
            </Link>
            <Link
              href="/yasal?section=gizlilik-politikasi"
              className="hover:underline"
            >
              Gizlilik Politikası
            </Link>
            <Link
              href="/yasal?section=kullanici-sozlesmesi"
              className="hover:underline"
            >
              Kullanıcı Sözleşmesi
            </Link>
            <Link
              href="/yasal?section=ucretler-ve-limitler"
              className="hover:underline"
            >
        ...
        <div>
          <Link href="/pakettlyukle" className="hover:underline">
            <h1 className="text-xl md:text-2xl font-bold mb-3">
              {getContent("footer_title_three")}
            </h1>
          </Link>
          <div className="flex flex-col space-y-2">
            <Link
              href="/pakettlyukle?section=hakkimizda"
              className="hover:underline"
            >
              Hakkımızda
            </Link>
            ...
            <Link
              href="/pakettlyukle?section=e-fatura"
              className="hover:underline"
            >
              E-fatura
            </Link>
        ...
        <div className="items-center">
          <p className="text-xs mt-3 pt-9">
            ...
            yetkilendirilmiş ödeme ve elektronik para kuruluşları ile iş
